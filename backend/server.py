...
try:
    ...
    # The explicit load parameter is the most reliable fix, but this global setting is good practice.
    try:
...
MODEL_FILE = os.environ.get("MODEL_FILE", str(ROOT_DIR / "model.h5"))
...
def load_keras_model():
    ...
    try:
        # **GUARANTEED FIX:** Pass safe_mode=False directly to load_model
