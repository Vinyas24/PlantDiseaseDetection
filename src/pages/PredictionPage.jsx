      ...
      <div className="prediction-container" data-testid="prediction-container">
        <div className="prediction-card">
          <div className="prediction-header">
            <Leaf size={32} className="prediction-header-icon" />
            <h2 data-testid="prediction-title">Plant Disease Detection</h2>
            <p>Upload a clear photo of a plant leaf to detect diseases</p>
          </div>
            ...
            <div className="result-box" data-testid="result-box">
              ...
              {prediction.description && (
                <div className="result-detail-box">
                  <h4>Description</h4>
                  <p data-testid="disease-description">{prediction.description}</p>
                </div>
              )}

              {prediction.possible_steps && (
                <div className="result-detail-box actions-box">
